...
- AMPL model files used for the optimization model.
- Processed data input files used by the models.
- Python scripts used for the empirical data analysis and preparation of model inputs.
- Selected model output files used to support the results presented in the thesis.
